...
// clears the current user brush and resets to the current real time data
  ...
  function generateAlarm (file, notify) {
    ...
    function onSnoozeUntilSelectChange() {
        var hrValue = snoozeUntilHrSelect.value;
        var minValue = snoozeUntilMinSelect.value;
        var now = new Date();
        var future = new Date(
            now.getFullYear(),
            now.getMonth(),
    ...
    snoozeUntilHrSelect.onclick = stopEventProp;
    ...
    snoozeUntilMinSelect.onclick = stopEventProp;
    ...
    var jQuerySnoozeUntilLiEl = $(snoozeUntilLiEl);
